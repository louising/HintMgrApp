...
-- ----------------------------
-- Table structure for t_hint_record_copy
-- ----------------------------
DROP TABLE IF EXISTS `t_hint_record_copy`;
CREATE TABLE `t_hint_record_copy` (
  `hint_record_id` char(32) NOT NULL,
  `hint_id` char(32) DEFAULT NULL,
  `project_id` char(32) DEFAULT NULL,
  `user_id` char(32) DEFAULT NULL,
...
-- ----------------------------
-- Records of t_hint_record_copy
-- ----------------------------
INSERT INTO `t_hint_record_copy` VALUES ('111', '4315847db8cc4bdb85370c19f1cdea59', '144f807280c34ad290493591a5cae4cb', 'sale01', '很好', '2021-11-01 20:18:28');
INSERT INTO `t_hint_record_copy` VALUES ('222', '4315847db8cc4bdb85370c19f1cdea59', '144f807280c34ad290493591a5cae4cb', 'build01', '完美', '2021-11-01 20:18:28');
INSERT INTO `t_hint_record_copy` VALUES ('333', '22', '144f807280c34ad290493591a5cae4cb', 'sale01', '待跟进', '2021-11-01 20:18:28');
INSERT INTO `t_hint_record_copy` VALUES ('444', 'e776626491004ee7883f7ec03aa726ce', '144f807280c34ad290493591a5cae4cb', 'sale01', '待跟进', '2021-11-02 20:18:28');
INSERT INTO `t_hint_record_copy` VALUES ('555', '5ec80ebdafcf43fb86799aeb157b23ef', '144f807280c34ad290493591a5cae4cb', 'sale01', '待跟进', '2021-11-02 20:18:28');
INSERT INTO `t_hint_record_copy` VALUES ('666', '830a411bf6144497ba0c284f249355d5', '4ed58177342d4ece9267a8ee096e8aa5', 'sale02', 'AAA', '2021-11-03 07:24:01');
INSERT INTO `t_hint_record_copy` VALUES ('777', '10965cb0a85048c4ae07f493232bde8b', '80af32d21a67406b9499299d544ecf57', 'sale02', 'BBB', '2021-11-03 07:24:01');
INSERT INTO `t_hint_record_copy` VALUES ('888', '9a60cd84117b4ffe87dc507f8080314e', '80af32d21a67406b9499299d544ecf57', 'sale03', 'CCC', '2021-11-03 07:24:01');
INSERT INTO `t_hint_record_copy` VALUES ('9e6dd9b69ca64a2599340968f29be819', '10965cb0a85048c4ae07f493232bde8b', '144f807280c34ad290493591a5cae4cb', 'build01', 'Very Good', '2021-11-05 07:24:01');
...
-- ----------------------------
-- Table structure for t_project_copy
-- ----------------------------
DROP TABLE IF EXISTS `t_project_copy`;
CREATE TABLE `t_project_copy` (
  `project_id` char(32) NOT NULL,
  `project_name` varchar(100) DEFAULT NULL,
  `project_admin_id` char(32) DEFAULT NULL,
  `project_area_admin_id` char(32) DEFAULT NULL,
...
-- ----------------------------
-- Records of t_project_copy
-- ----------------------------
INSERT INTO `t_project_copy` VALUES ('144f807280c34ad290493591a5cae4cb', '国际会展中心项目1', 'proj01', 'area01', '1', '国际会展中心项目 Desc', '2021-10-24 22:22:31', '2022-01-10 23:45:02', null, null);
INSERT INTO `t_project_copy` VALUES ('283b26c29ac148b1bdea47f019151713', '国际智慧小区项目2', null, 'area02', '1', null, '2021-10-24 22:22:31', null, null, null);
INSERT INTO `t_project_copy` VALUES ('36494b53277c4e25bf9ca2e0e23e4e38', '未来城市项目3', 'proj05', 'area02', '1', null, '2021-10-24 22:22:31', null, null, null);
INSERT INTO `t_project_copy` VALUES ('4ed58177342d4ece9267a8ee096e8aa5', '未来都市项目4', 'proj02', 'area01', '2', '未来都市项目 Desc', '2021-11-17 06:40:27', null, null, null);
INSERT INTO `t_project_copy` VALUES ('5e8b00909461477880bf78ac4efa3e68', '城市智慧国际交通项目5', null, 'area02', '1', '城市智慧交通项目 Desc', '2021-11-19 00:02:46', null, null, null);
INSERT INTO `t_project_copy` VALUES ('6e8b00909461477880bf78ac4efa3e6', '城市园林项目6', null, 'area02', '1', null, '2021-11-19 00:02:46', '2021-11-23 13:15:34', null, null);
INSERT INTO `t_project_copy` VALUES ('70af32d21a67406b9499299d544ecf57', 'Project 7', 'proj02', null, '1', 'New Desc', '2021-11-30 22:38:55', '2021-12-03 12:44:04', null, null);
INSERT INTO `t_project_copy` VALUES ('80af32d21a67406b9499299d544ecf57', 'Project 8', null, null, '1', 'New Desc', '2021-11-30 22:38:55', '2021-11-30 22:38:55', null, null);
...
-- ----------------------------
-- Table structure for t_role_copy
-- ----------------------------
DROP TABLE IF EXISTS `t_role_copy`;
CREATE TABLE `t_role_copy` (
  `role_id` char(32) NOT NULL,
  `role_name` varchar(50) DEFAULT NULL,
  `role_position` varchar(50) DEFAULT NULL,
  `hint_level` char(32) DEFAULT NULL,
...
-- ----------------------------
-- Records of t_role_copy
-- ----------------------------
INSERT INTO `t_role_copy` VALUES ('16803e86d0c5472686641365483f2d17', '区域管理员', '1', '158d2c57a27545c0a1eec33727b8033b', null, '2021-10-24 22:11:51');
INSERT INTO `t_role_copy` VALUES ('29c563e9b36a4d84bf4d7dfa0450dbf7', '项目管理员', '2', '158d2c57a27545c0a1eec33727b8033b', null, '2021-10-24 22:11:52');
INSERT INTO `t_role_copy` VALUES ('31bab25a8a7941459350217563573b23', '一级销售员', '3', '158d2c57a27545c0a1eec33727b8033b', null, '2021-10-24 22:11:53');
INSERT INTO `t_role_copy` VALUES ('32bab25a8a7941459350217563573b23', '二级销售员', '3', '2ccdc29c2474407ca4bcb1b51d65cdfe', '', '2021-10-24 22:11:53');
INSERT INTO `t_role_copy` VALUES ('412f6c8db4d94ac3a85249076717b809', '一级拓客员', '4', '158d2c57a27545c0a1eec33727b8033b', null, '2021-10-24 22:11:54');
INSERT INTO `t_role_copy` VALUES ('428c0a0514774f008f6ee65bfbad2b7b', '二级拓客员', '4', '2ccdc29c2474407ca4bcb1b51d65cdfe', 'Role 002', '2021-11-24 20:35:07');
INSERT INTO `t_role_copy` VALUES ('c45aefbda91941dcb977357455be1779', 'Role002 New', '4', '2ccdc29c2474407ca4bcb1b51d65cdfe', 'Role 002 New', '2021-11-24 20:32:39');
...
-- ----------------------------
INSERT INTO `t_user_copy` VALUES ('area01', 'Area 01', '13688889999', null, null, null, '1', '111', '16803e86d0c5472686641365483f2d17', null, '2021-11-01 20:01:04', null, '2021-12-06 22:40:27');
INSERT INTO `t_user_copy` VALUES ('area02', 'Area 02', '13824183324', null, null, null, '1', '112', '16803e86d0c5472686641365483f2d17', null, '2021-11-01 20:01:04', null, null);
INSERT INTO `t_user_copy` VALUES ('build01', 'Build 01', '13122223333', null, null, null, '1', '116', '412f6c8db4d94ac3a85249076717b809', '283b26c29ac148b1bdea47f019151713', '2021-11-01 20:01:04', null, '2021-12-08 23:30:44');
INSERT INTO `t_user_copy` VALUES ('build02', 'Build 02', '13122223333', '', null, '', '1', '116', '412f6c8db4d94ac3a85249076717b809', '144f807280c34ad290493591a5cae4cb', '2021-11-02 20:01:04', null, null);
INSERT INTO `t_user_copy` VALUES ('build03', 'Build 03', '13122223333', '', null, '', '1', '116', '428c0a0514774f008f6ee65bfbad2b7b', '36494b53277c4e25bf9ca2e0e23e4e38', '2021-11-02 20:01:04', null, '2021-12-08 23:30:44');
INSERT INTO `t_user_copy` VALUES ('build04', 'Build 04', '13122223333', '', '', '', '1', '116', '412f6c8db4d94ac3a85249076717b809', '283b26c29ac148b1bdea47f019151713', '2021-11-02 20:01:04', '', null);
INSERT INTO `t_user_copy` VALUES ('proj01', 'Project Admin 01', '13011112222', null, null, '202112/3b407312789e429c8f02f131924526e2', '1', '113', '29c563e9b36a4d84bf4d7dfa0450dbf7', '144f807280c34ad290493591a5cae4cb', '2021-11-01 20:01:04', null, null);
INSERT INTO `t_user_copy` VALUES ('proj02', 'Project Admin 02', '13011112222', '', null, '', '1', '114', '29c563e9b36a4d84bf4d7dfa0450dbf7', '', '2021-11-05 20:01:04', null, null);
INSERT INTO `t_user_copy` VALUES ('proj03', 'Project Admin 03', '', null, '', '', '1', null, '29c563e9b36a4d84bf4d7dfa0450dbf7', null, '2021-11-05 20:01:04', null, null);
INSERT INTO `t_user_copy` VALUES ('proj04', 'Project Admin 04', '', null, '', '', '1', null, '29c563e9b36a4d84bf4d7dfa0450dbf7', null, '2021-11-07 20:01:04', null, null);
INSERT INTO `t_user_copy` VALUES ('proj05', 'Project Admin 05', '', '', '', '', '1', '', '29c563e9b36a4d84bf4d7dfa0450dbf7', '', '2021-11-07 20:01:04', '', null);
INSERT INTO `t_user_copy` VALUES ('sale01', 'Sale 01', '13022224444', null, null, '202112/3b407312789e429c8f02f131924526e2', '1', '115', '31bab25a8a7941459350217563573b23', '144f807280c34ad290493591a5cae4cb', '2021-11-07 20:01:04', '4a7ea1', '2021-11-01 20:01:04');
INSERT INTO `t_user_copy` VALUES ('sale02', 'Sale 02', '13022224444', '', null, '202112/3b407312789e429c8f02f131924526e2', '1', '117', '428c0a0514774f008f6ee65bfbad2b7b', '144f807280c34ad290493591a5cae4cb', '2021-11-01 20:01:04', '4a7ea2', '2021-11-02 20:01:04');
INSERT INTO `t_user_copy` VALUES ('sale03', 'Sale 03', '13022224444', '', null, '', '1', '118', '31bab25a8a7941459350217563573b23', '144f807280c34ad290493591a5cae4cb', '2021-11-01 20:01:04', '4a7ea3', '2021-11-02 20:01:04');
INSERT INTO `t_user_copy` VALUES ('sale04', 'Sale 04', '13022224444', '', '', '', '1', '118', '428c0a0514774f008f6ee65bfbad2b7b', '283b26c29ac148b1bdea47f019151713', '2021-11-09 20:01:04', '4a7ea3', null);
INSERT INTO `t_user_copy` VALUES ('sale05', 'Sale 05', null, null, null, null, '1', null, '31bab25a8a7941459350217563573b23', '', '2021-11-09 20:01:04', null, '2021-12-07 05:07:39');
INSERT INTO `t_user_copy` VALUES ('sale06', 'Sale 06', null, null, null, null, '1', null, '428c0a0514774f008f6ee65bfbad2b7b', '', '2021-11-01 20:01:04', null, '2021-12-07 05:07:39');
