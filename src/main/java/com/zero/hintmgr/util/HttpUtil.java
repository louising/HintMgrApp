...
public class HttpUtil {
    ...
    static void test() throws Exception {
        ...
        String url = "", result = "";
        //1) GET
/*        String url = "http://localhost:8080/hintmgr/dummy/sysInfo";
        ...
        //2) POST
        url = "http://localhost:8080/hintmgr/dummy/page/3/2";
        url += "?name=" + URLEncoder.encode("Zenna李", "UTF-8");
        url += "&age=21";
        ...
        //3) POST        
        url = "http://localhost:8080/hintmgr/dummy/add";
        url += "?name=" + URLEncoder.encode("Zenna李", "UTF-8");
        url += "&age=21";
        JSONObject body = new JSONObject();
    ...
    * @param urlStr "http://localhost:8080/hintmgr/dummy/sysInfo?name=" + URLEncoder.encode("Zenna李", "UTF-8");
    ...
    * @param urlPath "http://localhost:8080/hintmgr/dummy/page/3/2?name=" + URLEncoder.encode("Zenna李", "UTF-8");
    * @param headers
